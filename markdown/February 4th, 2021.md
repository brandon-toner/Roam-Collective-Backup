...
`{{[[query]]: {or: [[ex-B]] [[ex-C]]}}}`
            - [[~[[Brandon Toner]]]] have you tried the [query builder](RoamJS Query Builder) script? You're right, it's still not as simple as a page filter but it brings the complexity of creating a query WAY down [*](((j2oZoVpHO)))
