- #Announcements **READ THIS**
    ...
    - Objective:: Create a [[Roam Collaboration Guide]]
    - Tips:: 
...
- #[[My Daily Notes]] [[Brandon Toner]] {{word-count}}
    - #Scratchpad
        - "Description of the [[DNP Modules]] #Conventions"
        - Thoughts about [Roam Collective]([[About [[Roam-Collective]]]])
            - "Purpose:: ((See block references for additional ideas.))" 
                - Converge ideas surrounding collaboration & a community hub for [[Roam Games]]
        ...
        - #Tips
            - Keep an eye on the [[block references]], they usually contain __commentary__ on that block. 
            - Use the (()) symbol to hide commentary on a block... 
                - Example:: "#[[Change Log]] ((This is VERY incomplete today since EVERYTHING is new))"
            - Use [[inline code-blocks]] to communicate the appropriate page convention without actually triggering a reference on a page. 
                - Example::
                    - "Maybe through strong onboarding? Clubhouse calls to address questions? Encouraging the use of the `#Questions` to create dialogue about conventions."
                        - In this example, I didn't want to use the `#Questions` tag because the block does not contain a question. But I wanted to show what tag would be appropriate to use. 
            - Build your own DNP Template[*](((tRcaU-Z93)))
        ...
        - [[Quick Start Guide]]
            1. "[[Brandon Toner]]"
            2. "Review the [conventions]([[Conventions]])"
    ...
    - #Administration
        ...
        - #[[Next Steps]] 
            ...
            9. {{[[DONE]]}} Add process for suggestions [*](((7PyTNYa6C)))
    ...
    - #[[Conversations and Meetings]]
        - Discussion:: [[[[Clubhouse]] conversation: Jan 25 2021]]
            - [[Kyle Stratis]]
                ...
                - Roam Lab
                    ...
                    - Avoid starting from scratch if possible
                        - Physics
                            - **Have intro physics already there and linked.**
                        - Marketplace for seeding community graph with.
            ...
            - [[Charles Farr]]
                - Seeding graphs
                - Shared graphs taper off
                    - Why? 
                    - Opportunity: Leverage something like Clubhouse.
    - #[[The Zettelkasten]]
    ...
    - #Promptstorming
        ...
        2. From the [[Prompts]] page: "What types of products or outcomes could collaborative communities work towards? How might this look?"
            - For book club:
                - Collaborative book summary
        ...
        5. "How important is it to stick to vanilla Roam?"
            - Tradeoffs = complexity and performance.
                - If complexity is kept at bay and graph speed and performance doesn't suffer, extensions can be helpful tools.
                    - I currently have [[Roam42]] installed.
    - #Comments
        1. Added [[roam/css]]
        ...
        4. "[[~]][[Brandon Toner]] any blocks you create we can't edit/delete — just something to keep in mind (see the duplicate comments and feedback sections below)" — fixed
        5. "[[~]] [[Brandon Toner]] how do you feel about using templates? I like these daily note headings — I think using either templates or smartblocks could be great to standardize structure..." Love templates, they help to facilitate structure — started some [here]([[Templates]])
    ...
    - #Chat
        ...
        - [[~]][[Charles Farr]] — Added [[Roam Collaboration Guide]] as a target artifact for this group. My thoughts is that if we can work to collaborate towards a finished product here, we can port the processes into [[Roam Book Club]] and other communities. 
            - My thoughts on process: #Processes
                - Brainstorm sections / table of contents
