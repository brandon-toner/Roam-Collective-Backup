...
- #[My Daily Notes](<My Daily Notes.md>) [Brandon Toner](<Brandon Toner.md>) {{word-count}}
    - [Scratchpad](<Scratchpad.md>)
        - "Description of the [DNP Modules](<DNP Modules.md>) [Conventions](<Conventions.md>)"
        - Thoughts about [Roam Collective]([About [[Roam-Collective](<About [[Roam-Collective.md>)]])
            - **["Purpose](<"Purpose.md>):** ((See block references for additional ideas.))" 
                - Converge ideas surrounding collaboration & a community hub for [Roam Games](<Roam Games.md>)
        ...
        - [Tips](<Tips.md>)
            - Keep an eye on the [block references](<block references.md>), they usually contain __commentary__ on that block. 
            - Use the (()) symbol to hide commentary on a block... 
                - **[Example](<Example.md>):** "#[Change Log](<Change Log.md>) ((This is VERY incomplete today since EVERYTHING is new))"
            - Use [inline code-blocks](<inline code-blocks.md>) to communicate the appropriate page convention without actually triggering a reference on a page. 
                - **[Example](<Example.md>):**
                    - "Maybe through strong onboarding? Clubhouse calls to address questions? Encouraging the use of the `[Questions](<Questions.md>)` to create dialogue about conventions."
                        - In this example, I didn't want to use the `[Questions](<Questions.md>)` tag because the block does not contain a question. But I wanted to show what tag would be appropriate to use. 
    ...
    - [Administration](<Administration.md>)
        ...
        - #[Next Steps](<Next Steps.md>) 
            ...
            8. [x] Add CSS tagging
            9. [x] Add process for suggestions [*](((7PyTNYa6C)))
    ...
    - [Promptstorming](<Promptstorming.md>)
        ...
        2. From the [Prompts](<Prompts.md>) page: "What types of products or outcomes could collaborative communities work towards? How might this look?"
            - For book club:
        ...
        5. "How important is it to stick to vanilla Roam?"
            - Tradeoffs = complexity and performance.
                - If complexity is kept at bay and graph speed and performance doesn't suffer, extensions can be helpful tools.
                    - I currently have [Roam42](<Roam42.md>) installed.
    - [Comments](<Comments.md>)
        ...
        4. "[~](<~.md>)[Brandon Toner](<Brandon Toner.md>) any blocks you create we can't edit/delete — just something to keep in mind (see the duplicate comments and feedback sections below)" — fixed
