...
`{{[query](<query.md>): {or: [ex-B](<ex-B.md>) [ex-C](<ex-C.md>)}}}`
            - [~[[Brandon Toner](<~[[Brandon Toner.md>)]] have you tried the [query builder](RoamJS Query Builder) script? You're right, it's still not as simple as a page filter but it brings the complexity of creating a query WAY down [*](((j2oZoVpHO)))
