...
```
        4. `Areas Tags`
            - `#[Administration](<../Administration.md>)
                - ```css
span.rm-page-ref[data-tag="Administration"] {
    background: [607D8B](<../607D8B.md>);
    color: [fff](<../fff.md>);
    padding: 2px 5px 2px 5px;
    font-size: 13px;
...
span.rm-page-ref[data-tag="Administration"]:before {
    content: '🏛'
}```
        5. `Data-type Tags`
...
span.rm-page-ref[data-tag="My Daily Notes"]:before {
    ...
    margin-top: -11px;
            ...
            - #[Posted by](<../Posted by.md>) [Your Name](<../Your Name.md>)
                - ```css
span.rm-page-ref[data-tag="Posted by"] {
	background-image: linear-gradient(to right, [607D8B](<../607D8B.md>),[607D8B](<../607D8B.md>));
	background-size: 100%;
    color: rgb(255,255,255);
    padding: 3px 2px 3px 5px;
 ...
 span.rm-page-ref[data-tag="Posted by"] + span[data-link-title] {
     background: [e4ffe3](<../e4ffe3.md>) !important;
     color: [F3F7F2](<../F3F7F2.md>) !important;
     padding: 3px 5px 3px 15px;
     font-size: 13px;
...
span.rm-page-ref[data-tag="Posted by"]:after, span.rm-page-ref[data-tag="Post"]:before {
    left: 100%;
    top: 50%;
    border: solid transparent;
    content: " ";
...
span.rm-page-ref[data-tag="Posted by"]:after {
    border-color: rgba(255,255,255,0);
    border-left-color: [607D8B](<../607D8B.md>);
    border-width: 11px;
    margin-top: -11px;
...
span.rm-page-ref[data-tag="Posted by"]:before {
    border-color: rgba(255,255,255,0);
    border-left-color: [607D8B](<../607D8B.md>);
    border-width: 11px;
    margin-top: -11px;
...
span.rm-page-ref[data-tag="Question"] {
	background-image: linear-gradient(to right, [f9d771](<../f9d771.md>),[f9d771](<../f9d771.md>));
	background-size: 100%;
    color: black;
    padding: 3px 2px 3px 5px;
    font-size: 13px;
...
span.rm-page-ref[data-tag="Question"]:after {
    border-color: rgba(255,255,255,0);
    border-left-color: [f9d771](<../f9d771.md>);
    border-width: 11px;
    margin-top: -11px;
}
...
```
        12. `#[Actions Taken](<../Actions Taken.md>)
            - ```css
span.rm-page-ref[data-tag="Actions Taken"] {
    background: [9E9E9E](<../9E9E9E.md>);
    color: [fff](<../fff.md>);
    padding: 2px 5px 2px 5px;
    font-size: 13px;
...
span.rm-page-ref[data-tag="Actions Taken"]:before {
    content: '✅'
}```
...
span.rm-page-ref[data-tag="Action Items"]:before {
    content: '🚩'
        ...
        14. `#[Focus Mode](<../Focus Mode.md>)
            - ```css
span.rm-page-ref[data-tag="Focus Mode"] {
    background: [607D8B](<../607D8B.md>);
    color: [fff](<../fff.md>);
    padding: 2px 5px 2px 5px;
    font-size: 13px;
...
span.rm-page-ref[data-tag="Focus Mode"]:before {
    content: '🎯'
}```
...
.rm-block-ref {
    ...
    color: [009688](<../009688.md>);
  	...
  	text-decoration-color: [FF9800](<../FF9800.md>); */
            ...
            - [[[Roam Book Club](<../[[Roam Book Club.md>) II]] styling [Status](<../Status.md>)/Enabled
                - ```ruby
...
.rm-block-ref{
    color: [2d249a](<../2d249a.md>); 
    background-color: [b9f7ef](<../b9f7ef.md>);
}```
            - Block Reference Indicator Symbol 
                - ```css
/*Block Reference formatting*/
...
/*  line-height: 12px;*/
  ...
  min-height: 0px;
    ...
    3. Other Styling [frills](<../frills.md>)
...
- [ ] Adjust the [roam/css](<../roam/css.md>)

- [x] Make the tags grey (how to I change that in [roam/css](<../roam/css.md>))
...
- [November 17th, 2020](<../November 17th, 2020.md>) BIG Update to [roam/css](<../roam/css.md>)
